namespace tp2JordanCoutureLafranchise.Models
{
    public class BaseDeDonnees
    {
        ...
        public BaseDeDonnees()
        {
            ...
            {
                new Parent() {Id=1, Nom="Penguins de Pittsburgh", NbJoueurs=4, SalaireMoyen=0, Description="Équipe de hockey sur glace de la LNH basée à Pittsburgh", ImageURL="/Images/pittsburgh.png"},
                new Parent() {Id=2, Nom="Canadiens de Montréal", NbJoueurs=4, SalaireMoyen=0,Description="Équipe de hockey sur glace de la LNH basée à Montréal", ImageURL="/Images/Mon_projet_1.png"},
                new Parent() {Id=3, Nom="Capitals de Washington", NbJoueurs=4, SalaireMoyen=0, Description="Équipe de hockey sur glace de la LNH basée à Washington", ImageURL="/Images/capitals.png"}
            };

            Enfants = new List<Enfant>()
            {
                    new Enfant() {Id=1, IdParent=2, ImageURL="/Images/niskcsuzuki-removebg-preview.png", Nom="Nick Suzuki",
                   ...
                   new Enfant() {Id=2, IdParent=2, ImageURL="/Images/8481540_3x-removebg-preview.png", Nom="Cole Caufield",
                    ...
                    new Enfant() {Id=3, IdParent=2, ImageURL="/Images/8474596_3x-removebg-preview.png", Nom="Jake Allen",
                    ...
                    new Enfant() {Id=4, IdParent=2, ImageURL="/Images/8476469_3x-removebg-preview.png", Nom="Joel Armia",
                    ...
                    new Enfant() {Id=5, IdParent=3, ImageURL="/Images/8471698_3x-removebg-preview.png", Nom="T.J. Oshie",
                    ...
                    new Enfant() {Id=6, IdParent=3, ImageURL="/Images/8475625_3x-removebg-preview.png", Nom="Matt Irwin",
                    ...
                    new Enfant() {Id=7, IdParent=3, ImageURL="/Images/8471214_3x__1_-removebg-preview.png", Nom="Alex Ovechkin",
                    ...
                    new Enfant() {Id=8, IdParent=3, ImageURL="/Images/8475324_3x-removebg-preview_1.png", Nom="Nick Jensen",
                    ...
                    new Enfant() {Id=9, IdParent=1, ImageURL="/Images/8473507_3x-removebg-preview.png", Nom="Jeff Petry",
                    ...
                    new Enfant() {Id=10, IdParent=1, ImageURL="/Images/8480172_3x-removebg-preview.png", Nom="Jan Rutta",
                    ...
                    new Enfant() {Id=11, IdParent=1, ImageURL="/Images/ç-removebg-preview.png", Nom="Bryan Rust",
                    ...
                    NumeroDeChandail=17, Age="31 ans", Position="AD", Salaire=6, Equipe="Penguins de Pittsburgh", EnVedette="Oui"},
                     ...
                     new Enfant() {Id=12, IdParent=1, ImageURL="/Images/8470604_3x-removebg-preview.png", Nom="Jeff Carter",
